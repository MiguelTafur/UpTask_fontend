...
import DeleteProjectModal from '@/components/profiles/DeleteProjectModal'
...
export default function DashboardView() {
  ...
  if(data && user) return (
    <>
        ...
        <nav className="my-5">
            <Link className="bg-purple-400 hover:bg-purple-500 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-color" to='/projects/create'>
                Nuevo Proyecto
            </Link>
        </nav>
